...
var toolbar_dropdownlist_component_1 = require("../tools/toolbar-dropdownlist.component");
...
var EditorDropDownDirective = /** @class */ (function () {
    ...
    EditorDropDownDirective.ctorParameters = function () { return [
        { type: toolbar_dropdownlist_component_1.ToolBarDropDownListComponent, },
        { type: editor_component_1.EditorComponent, decorators: [{ type: core_1.Host },] },
    ]; };
    EditorDropDownDirective.propDecorators = {
        'command': [{ type: core_1.Input, args: ['kendoEditorDropDown',] },],
    };
    return EditorDropDownDirective;
}());
exports.EditorDropDownDirective = EditorDropDownDirective;
