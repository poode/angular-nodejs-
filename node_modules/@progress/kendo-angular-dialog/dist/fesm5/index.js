...
var DialogService = /** @class */ (function () {
    ...
    DialogService.prototype.initializeDialog = function (component, factory, container, dialogRef, options) {
        ...
        var result = merge$1(apiClose, dialog.instance.close, dialog.instance.action).pipe(take$1(1));
...
var createMoveStream = function (el, ev) { return function (mouseDown) {
    return el.kendo.drag
        .pipe(takeUntil$1(el.kendo.release.pipe(tap$1(function () { ev.emit(); }))), map$1(function (_a) {
...
var DragResizeService = /** @class */ (function () {
    ...
    DragResizeService.prototype.onDrag = function (el) {
        ...
        this.subscriptions.add(this.ngZone.runOutsideAngular(function () {
            ...
            _this.dragSubscription = el.kendo.press
                ...
                dragStarted = false;
            }), switchMap$1(preventOnDblClick(el.kendo.release)), switchMap$1(createMoveStream(el, _this.dragEnd)))
    ...
    DragResizeService.prototype.onResize = function (handle, direction) {
        ...
        this.subscriptions.add(this.ngZone.runOutsideAngular(function () {
            ...
            handle.kendo.press.pipe(tap$1(function (ev) {
                preventDefault(ev);
                _this.focus.emit();
                startOffsetAndPosition = _this.currentOffsetAndPosition();
                resizeStarted = false;
            }), switchMap$1(preventOnDblClick(handle.kendo.release)), switchMap$1(createMoveStream(handle, _this.resizeEnd)))
                .subscribe(function (_a) {
                var pageX = _a.pageX, pageY = _a.pageY, originalX = _a.originalX, originalY = _a.originalY;
                if (!resizeStarted) {
...
var ResizeHandleDirective = /** @class */ (function () {
    ...
    ResizeHandleDirective.prototype.ngOnInit = function () {
        ...
        this.subscriptions.add(of$1(this.draggable).subscribe(function (handle) {
        ...
        this.subscriptions.add(merge$1(this.service.resizeEnd, this.service.dragEnd).subscribe(function () {
...
var WindowTitleBarComponent = /** @class */ (function () {
    ...
    WindowTitleBarComponent.prototype.subscribeDrag = function () {
        var _this = this;
        this.unsubscribeDrag();
        this.dragSubscription = of$1(this.dragDirective).subscribe(function (titleBar) {
...
var WindowService = /** @class */ (function () {
    ...
    WindowService.prototype.open = function (settings) {
        ...
        var result = merge$1(apiClose, window.instance.close).pipe(take$1(1));
        result.subscribe(close);
