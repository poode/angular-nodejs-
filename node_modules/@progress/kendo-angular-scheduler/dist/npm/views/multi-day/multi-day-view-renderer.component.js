...
var MultiDayViewRendererComponent = /** @class */ (function (_super) {
    ...
    function MultiDayViewRendererComponent(localization, viewContext, viewState, intl, slotService, zone, renderer, element, changeDetector, pdfService) {
        ...
        _this.allDayItems = new BehaviorSubject_1.BehaviorSubject(null);
        return _this;
    }
    ...
    MultiDayViewRendererComponent.prototype.canDragTo = function (task, slot) {
        var result = !(!slot.isDaySlot && task.isAllDay && utils_1.isMultiDay(task));
        return result;
    };
    ...
    MultiDayViewRendererComponent.prototype.initResizeContainer = function (target) {
        var container = dom_queries_1.closestInScope(target, function (node) { return dom_queries_1.hasClasses(node, 'k-scheduler-header-wrap k-scheduler-content'); }, this.element.nativeElement);
        if (container) {
            if (dom_queries_1.hasClasses(container, 'k-scheduler-header-wrap')) {
                container = container.children[1];
            }
            this.container = container;
            this.containerOffset = utils_2.elementOffset(container);
        }
    };
