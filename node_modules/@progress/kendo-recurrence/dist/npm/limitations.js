...
/** @hidden */
exports.months = function (date, end, rule) {
...
/** @hidden */
exports.monthDays = function (date, end, rule) {
...
/** @hidden */
exports.yearDays = function (date, end, rule) {
...
/** @hidden */
exports.weeks = function (date, end, rule) {
    var weekStart = rule.weekStart || kendo_date_math_1.Day.Monday, year, weekRuleValues, day, changed = false, normalize = function (week) {
        if (week < 0) {
            week = 53 + week;
        }
        return week;
...
/** @hidden */
exports.weekDays = function (startDate, end, rule) {
...
/** @hidden */
exports.hours = function (date, end, rule) {
...
/** @hidden */
exports.minutes = function (date, end, rule) {
...
/** @hidden */
exports.seconds = function (date, _end, rule) {
