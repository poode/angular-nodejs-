...
var PanelBarComponent = /** @class */ (function () {
    ...
    Object.defineProperty(PanelBarComponent.prototype, "computedKeys", {
        get: function () {
            var _this = this;
            return _a = {}, _a[Keys.space] = function () { return _this.selectFocusedItem(); }, _a[Keys.enter] = function () { return _this.selectFocusedItem(); }, _a[Keys.up] = function () { return _this.focusPreviousItem(); }, _a[this.invertKeys(Keys.left, Keys.right)] = function () { return _this.collapseItem(); }, _a[Keys.down] = function () { return _this.focusNextItem(); }, _a[this.invertKeys(Keys.right, Keys.left)] = function () { return _this.expandItem(); }, _a[Keys.end] = function () { return _this.focusLastItem(); }, _a[Keys.home] = function () { return _this.focusFirstItem(); }, _a;
            var _a;
        },
        enumerable: true,
        configurable: true
...
var TabStripComponent = /** @class */ (function () {
    ...
    Object.defineProperty(TabStripComponent.prototype, "computedKeys", {
        get: function () {
            var _this = this;
            return _a = {}, _a[this.invertKeys(Keys.left, Keys.right)] = function (selectedIndex) { return _this.prevNavigatableIndex(selectedIndex); }, _a[this.invertKeys(Keys.right, Keys.left)] = function (selectedIndex) { return _this.nextNavigatableIndex(selectedIndex); }, _a[this.invertKeys(Keys.down, Keys.up)] = function (selectedIndex) { return _this.nextNavigatableIndex(selectedIndex); }, _a[this.invertKeys(Keys.up, Keys.down)] = function (selectedIndex) { return _this.prevNavigatableIndex(selectedIndex); }, _a[Keys.home] = function () { return _this.firstNavigatableIndex(); }, _a[Keys.end] = function () { return _this.lastNavigatableIndex(); }, _a;
            var _a;
        },
        enumerable: true,
        configurable: true
...
var createMoveStream = function (draggable) { return function (mouseDown) {
    return draggable.kendo.drag
        .pipe(takeUntil$1(draggable.kendo.release), map$1(function (_a) {
...
var SplitterBarComponent = /** @class */ (function () {
    ...
    SplitterBarComponent.prototype.ngOnInit = function () {
        var _this = this;
        var state$$1;
        var listener = this.draggable.kendo.press.pipe(tap$1(stopPropagation), filter$1(function () { return _this.splitter.isDraggable(_this.index); }), tap$1(function () { return state$$1 = _this.splitter.dragState(_this.index); }), tap$1(function () { return _this.splitter.toggleContentOverlay(_this.index, true); }), switchMap$1(preventOnDblClick(this.draggable.kendo.release)), switchMap$1(createMoveStream(this.draggable))).subscribe(function (_a) {
