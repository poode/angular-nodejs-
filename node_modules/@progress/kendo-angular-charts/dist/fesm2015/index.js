import { ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChild, ContentChildren, Directive, ElementRef, EventEmitter, Inject, Injectable, InjectionToken, Input, NgModule, NgZone, Optional, Output, Renderer2, TemplateRef, ViewChild, ViewChildren, isDevMode } from '@angular/core';
...
class ConfigurationService {
    ...
    initSource() {
        ...
        this.onChange$ = this.onFastChange$.pipe(auditTime$1(THROTTLE_MS));
    }
    push(store) {
        this.store = store;
        this.next();
...
/** @nocollapse */
TooltipTemplateService.ctorParameters = () => [];
...
class ChartComponent extends ChartComponentGenerated {
    ...
    refreshWait() {
        this.ngZone.runOutsideAngular(() => {
            this.subscription = combineLatest$1(this.configurationService.onChange$, this.themeService.onChange$, (options, theme) => {
                this.options = options;
                this.theme = theme;
            }).pipe(auditTime$1(THROTTLE_MS))
                .subscribe(() => {
                this.refresh();
            });
        });
...
/** @nocollapse */
RootConfigurationService.ctorParameters = () => [];
