...
var TooltipSettings = /** @class */ (function () {
    ...
    /** @nocollapse */
    TooltipSettings.ctorParameters = function () { return []; };
...
var TooltipDirective = /** @class */ (function () {
    function TooltipDirective(tooltipWrapper, ngZone, renderer, popupService, localizationService, settings, legacySettings) {
        ...
        this.ngZone.runOutsideAngular(function () {
            ...
            _this.anchorTitleSubscription = fromEvent$1(wrapper, 'mouseover')
                .pipe(filter$1(function () { return _this.filter !== ''; }))
            ...
            _this.mouseOverSubscription = fromEvent$1(wrapper, 'mouseover')
                .pipe(debounceTime$1(100), filter$1(function () { return _this.filter !== ''; }))
                .subscribe(function (e) { return _this.onMouseOver(e); });
            _this.mouseOutSubscription = fromEvent$1(wrapper, 'mouseout')
    ...
    TooltipDirective.prototype.openPopup = function (anchorRef) {
        ...
        if (this.showOn === 'hover') {
            this.ngZone.runOutsideAngular(function () {
                ...
                _this.popupMouseOutSubscription = fromEvent$1(popup, 'mouseout')
                    .subscribe(function (e) { return _this.onMouseOut(e); });
            });
        }
    };
